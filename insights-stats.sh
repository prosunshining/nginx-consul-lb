...
echo /tmp/insights.json | curl -d @- -X POST -H "Content-Type: application/json" -H "X-Insert-Key: G3f-bY7a18lj9DfnJtyijd9BofZamNxI" https://insights-collector.newrelic.com/v1/accounts/1136088/events
